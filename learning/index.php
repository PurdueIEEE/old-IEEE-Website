        ...
        <div class="row">
            <div class="col-md-8 text-dark col-md-offset-2 text-dark">
                ...
                <h3>IEEE x SWE x WiA Soldering Workshops</h3>
					<p>Come to our soldering workshop sessions on Thurs, March 22nd or on Thurs, March 29th at 6PM in FRNY G124 to learn how to solder! This is brought to you by Purdue IEEE, Purdue Society of Women of Engineers (PSWE), and Women in Aerospace(WiA). We will
					be soldering a 4-bit binary adder to learn both surface-mount
					soldering and through-hole soldering. Please RSVP <a href="https://goo.gl/forms/CfUEdsZRWmjyrb4O2" style="text-decoration:underline" target="_blank">HERE</a>.
					IMPORTANT: Members of the above clubs participate for free! All others have to pay $5 to participate.</p>
				<hr>
				<img src = "images/codecafe_final_w_date.jpg" style="width: 100%">
                <h3>Code Cafe</h3>
					<p>Code Cafe is back this spring on Saturday, March 31st from 1PM - 6PM in WALC B074! Learn the basics of programming using Python, one of the most intuitive and popular coding languages, and enjoy a free coffee/expresso bar with snacks! Please bring your laptop and charger. To RSVP as a student, fill out this form. Spots fill up quickly! However, if you're good at Python and are interested to be a mentor (accepted mentors get a free T-shirt), please apply here.
					Visit our website at <a href="https://codecafe.purdueieee.org" style="text-decoration:underline" target="_blank">Code Cafe</a></p>
                ...
                <h3>Code Cafe</h3>
					<p>Ever wanted to learn how to code? Come to Code Cafe in WALC B074 from 1PM to 6PM on Saturday, October 14th to learn the basics of programming using Python, one of the most intuitive and popular coding languages. We have a free coffee/expresso bar and snacks! Please bring your laptop and charger! 
					</p>
				
				<hr>
				<img src = "images/3dPrint.png" style="width: 100%">
                <h3>3D Printing</h3>
					<p>3D printing refers to the process of creating 3-dimensional objects from layers of material.This will be organized as a showcase with an introduction to 3D printer filaments, how to use slicers, and how to purchase your first printer. 
					</p>
                ...
                <h3>EAGLE Training Session</h3>
					<p>This training session will cover the basics of EAGLE, an electrical board schematic and layout tool. The training session is split into three parts, that will teach how to create schematics, board layouts, and parts. No prior knowledge is required. Additional details below:
					</p>

                <p><strong>TODO: Before you come to this session, there are a few requirements.</strong></p>
                <ul>
                    <li>Download EAGLE and the Sparkfun Libraries. Instructions on downloading and setup can be found on <a href="https://learn.sparkfun.com/tutorials/how-to-install-and-setup-eagle">Sparkfun's website.</a></li>
                    <li>Suggested Reading: To get an overview of the topics we will cover at the first lesson, read <a href="https://learn.sparkfun.com/tutorials/using-eagle-schematic">Sparkfun's schematic tutorial</a></li>
                </ul>
                <p><strong>Things to bring:</strong></p>
                <ul>
                    <li>Laptop with EAGLE installed, a mouse (recommended), charged battery (some outlets available)</li>
                </ul>
				
				<hr>
				<img src = "images/solidworks.png" style="width: 100%">
                <h3>SolidWorks Training Session</h3>
					<p>Learn the basics of 3D modeling with one of the most widely utilized software’s in industry, SolidWorks! This introductory series will cover basic parametric modeling with a focus on best practices so that you can create better, more robust models.
					</p>

				<hr>
				<img src = "images/github.png" style="width: 100%">
                <h3>Git + GitHub</h3>
					<p>This session will cover the basics of using git and GitHub. Git is a version control software that makes saving your old code and reverting changes much easier. GitHub is a remote location to store your code and collaborate with other people through merging and code reviews. The session will cover only command line tools, so familiarity with the command line is helpful.
					</p>

				<hr>
				<img src = "images/EmailLogo.jpg" style="width: 100%">
				<h3>Professional Emails</h3>
					<p>Want to impress or gain attention of companies with your writing skills? Often, you have to write emails to do so. It's easy to write an email, but it's a little more difficult to write professional ones. Come to this workshop in WALC 2088 at 6:30PM on Thursday, November 2nd to learn about the email etiquette and mechanics that'll get employers to treat you more seriously!
					</p>
