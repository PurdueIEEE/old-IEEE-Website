    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="/mtts/bylaws/" class="list-group-item active">Bylaws</a>
        ...
        <div class="col-md-7 text-dark col-md-offset-1">
            ...
            <h1 class="text-center">Microwave Theory and Techniques Society (MTT-S) Chapter Bylaws</h1></br>

            <h4 class="text-center"><em>Name and Purpose</em></h4>
            ...
            <br><h4 class="text-center"><em>Membership</em></h4>
            <p class="text-justify">
            ...
            <br><h4 class="text-center"><em>Leadership</em></h4>
            <p class="text-justify">
                The Purdue IEEE MTT-S leadership shall consist of the following voting individuals:
            <ul>
                <li>MTT-S Chair</li>
                <li>MTT-S Vice Chair</li>
                <li>MTT-S Sponsorship Coordinator</li>
                <li>MTT-S Workshop Coordinator</li>
                <li>MTT-S Event Coordinator</li>
                <li>Approved subcommittee directors</li>
            </ul>




            The MTT-S Chair alone will exercise the ability to vote within the Executive Committee of Purdue IEEE Student Branch. The MTT-S Sponsorship Coordinator, MTT-S Workshop Coordinator, and MTT-S Event Coordinator shall be the Professional Committee representative, Learning Committee representative, and Social Committee representative respectively to the Cornerstones committees of Purdue IEEE Student Branch on behalf of MTT-S members.
            ...
            <br><h4 class="text-center"><em>Procedure for Decisions</em></h4>
            <p class="text-justify">
            ...
            <br><h4 class="text-center"><em>Amendments to Bylaws</em></h4>
            <p class="text-justify">
            ...
            <br><h4 class="text-center"><em>Society Dues</em></h4>
            <p class="text-justify">
            ...
            <br><h4 class="text-center"><em>Subcommittees</em></h4>
            <p class="text-justify">
