        ...
        <div class="col-md-7 text-dark col-md-offset-1">
            ...
            <div class="row">
                <div class="col-md-4 text-dark">
                    <p class="text-center"><a href="https://drive.google.com/drive/folders/0B294lHhVhuGqN0NMRzJWaDRUVTA">Project Pictures</a></p>
                </div>
                <div class="col-md-4 text-dark">
                    <p class="text-center"><a href="https://docs.google.com/document/d/1ViOew31AfFHZWVhkwVVyd7R7Bux77QwaPv_L9Yn0GVk">Description Sheet</a></p>
                </div>
                <div class="col-md-4 text-dark">
