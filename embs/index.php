...
<div class="well card-1 text-dark">
    <div class="row text-center">
        ...
        <div class="row">
            <!--Chair-->
            <div class="col-md-4">
                <img src="/images/officers/2018_Kim_Eugene.jpg" alt="Eugene Kim" class="img-circle"
            ...
            <!--Vice-Chair-->
            <div class="col-md-4">
                <img src="./images/2018_Obeng-Gyasi_Barnabas.JPG" alt="Barnabas Obeng-Gyasi" class="img-circle"
                     width=250px height=250px/>
                <h4>Barnabas Obeng-Gyasi</h4>
                <p>Vice Chair<br/>Neurobiology & Physiology<br/>Junior</p>
            </div>
            <!--Correspondence Liaison-->
            <div class="col-md-4">
                <img src="./images/2018_Moryl_Dana.jpg" alt="Dana Moryl" class="img-circle"
                     width=250px height=250px/>
                <h4>Dana Moryl</h4>
                <p>Corespondance Liason<br/>Biomedical Engineering<br/>Senior</p>
            </div>
        </div>
        <br/>
        <div class="row">
            <!--Industrial Liaison-->
            <div class="col-md-6">
                <img src="./images/2018_Bhagwat_Apoorva.jpg" alt="Apoorva Bhagwat" class="img-circle"
                     width=250px height=250px/>
                <h4>Apoorva Bhagwat</h4>
                <p>Industrial Liaison<br/>Biomedical Engineering<br/>Senior</p>
            </div>
            <!--Technical Lead-->
            <div class="col-md-6">
                <img src="./images/white.jpg" alt="Sean Bucherl" class="img-circle" width=250px height=250px/>
                <h4>Sean Bucherl</h4>
                <p>Technical Lead<br/>Biomedical Engineering<br/>Senior</p>
            </div>
        </div>
        <br/><br/>
    </div>
    ...
    <div class="row text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <br/><br/>
                <h4>Dog Shelter</h4>
                <p>We're partnering with Circle-K on volunteering in the local community, building biomedical
