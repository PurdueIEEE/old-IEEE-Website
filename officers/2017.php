...
?>
    <div class="well card-1 text-dark">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h3>Jessica Chin</h3>
                <h4>Vice President (Spring) &amp Secretary (Fall)</h4>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/Michael_Anderson.jpg')">
                </div>
            </div>
            <div class="col-md-9">
                <h3>Michael Anderson</h3>
                <h4>Treasurer</h4>
                <p>Michael is a senior in Industrial Engineering. He joined IEEE Fall 2016 and became MTT-S Vice Chair Spring 2017. He plans to work in manufacturing in order to use his problem solving and people skills. As Treasurer, he hopes to aid committees when dealing with the university and to grow the selection of available Purdue IEEE merchandise. In his free time, he enjoys reading, playing video games, or hanging with friends. He is scheduled to graduate Spring 2018.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <p>Yash is a senior in Multidisciplinary Engineering. He joined IEEE in the fall of 2014 to work on the Aerial Robotics committee. He hopes to combine his engineering knowledge with a business background. As Social Head, he hopes to create an opportunity for any student to join and feel welcome in IEEE, and have the opportunity to meet new people and provide them with several engaging activities to participate in. In his free time, he is a movie buff and enjoys cooking, playing and watching sports, and playing video games.</p>
        ...
        <hr>
        <!-- Committee Chair #5 (Fall and Spring) -->
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/Adrian_White.jpg')">
                </div>
            </div>
            <div class="col-md-9">
                <h3>Adrian White</h3>
                <h4>Racing Committee Chair (Fall and Spring)</h4>
