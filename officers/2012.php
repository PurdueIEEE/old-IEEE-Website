...
?>
    ...
    <div class="well card-1 text-dark">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/President_Spencer.jpg')">
                </div>
            </div>
            <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/VP_Michael.jpg')">
                </div>
            </div>
            <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/Secretary_Thor.png')">
                </div>
            </div>
            <div class="col-md-9">
                <h3>Thor Smith</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h3>Eugene Anane-wae</h3>
                <h4>Industrial Relations Head and MARS Committee Chair</h4>
                <p></p>
                <p><em>Committee Involvement</em>: MARS</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/Aerial_Matt_Carrell.jpg')">
                </div>
            </div>
            <div class="col-md-9">
                <h3>Matt Carrell</h3>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="officer-cropped"
                    style="background-image: url('/images/officers/CSociety_Nick_2012.jpg')">
                </div>
            </div>
            <div class="col-md-9">
                <h3>Nick Molo</h3>
