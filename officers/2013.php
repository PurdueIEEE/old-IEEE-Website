<?php 
	$title = '2013 Officers - Purdue IEEE';
	include '../header.php';
?>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li class="active">2013 Officers</li>
			</ol>
		</div>
	</div>
	<!-- /.row -->
	...
	<div class="well text-dark">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<p><em>Committee Involvement</em>: <a href="/committees/rov/">ROV</a>, <a href="/committees/csociety/">Computer Society</a></p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/VP_Flor.jpg')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>Flor Albornoz</h3>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
				style="background-image: url('/images/Officers/Treas_Chandu_Reddy.jpg')">
			</div>
		</div>
		<div class="col-md-9">
			<h3>Chandrahas Reddy</h3>
			<h4>Treasurer and Mobile Autonomous Robot Squad (MARS) Committee Chair (both Fall 2013)</h4>
			<p>Chandu is a Sophomore in Electrical Engineering Technology at Purdue. Chandu started participating in the IEEE in Fall 2012. He is an active member on the Electrical Team of the ROV Committee and also is the Commander of MARS. As Treasurer, Chandu is in charge of overseeing the finances of the whole organization and its five committees.</p>
			<p><em>Committee Involvement</em>: MARS, <a href="/committees/rov/">ROV</a></p>
		</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/John_Lee.jpg')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>John Lee</h3>
				<h4>Treasurer (Spring 2014)</h4>
				<p>John is a Sophomore in Computer Engineering. Since his arrival in IEEE during the Fall of 2013, John has moved up from among the different organizations within IEEE. From heading a project on a Portal turret (currently in progress) to becoming the current Treasurer and a software developer for the ROV Committee, John has developed and continues to develop knowledge regarding the inner workings of the organization. His scheduled graduation is May 2016.</p>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/Secretary_Reid.jpg')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>Reid Fouch</h3>
				<h4>Secretary</h4>
				<p>Reid is a Senior in Elementary Education here at Purdue University. He first joined the Purdue IEEE chapter in the Fall of 2010. During his tenure with the club he has been a member of MARS, ROV, and the Learning Committee (now defunct) as well as the chair of the Racing committee and Computer Society. While he was in the Electrical Engineering program, he participated in the co-op program with Gulfstream Aerospace. As Secretary, he records the happenings of the different committees and advises the committee chairs.</p>
				<p><em>Committee Involvement</em>: <a href="/committees/learning/">Learning</a>, <a href="/committees/csociety/">Computer Society</a>, <a href="/committees/racing/">Racing</a>, <a href="/committees/rov/">ROV</a>, MARS</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/Darius.png')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>Darius Pang</h3>
				<h4>Aerial Robotics Committee Chair</h4>
				<p>Darius Pang is a Freshman entering Mechanical Engineering who joined Purdue IEEE in his first semester at Purdue. Since then, he has worked as Secretary now Captain of the Aerial Robotics Committee. Darius is strongly interested in working in the aerospace/aeronautical and defense field. His focus is in automatic control systems. On the side, he enjoys 3D modelling and learning about various computer components. Darius is scheduled to graduate in Spring 2017.</p>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/CSociety_Nick.png')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>Nick Molo</h3>
				<h4>Computer Society President (Fall 2013)</h4>
