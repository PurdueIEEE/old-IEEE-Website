<?php 
	$title = '2015 Officers - Purdue IEEE';
	include '../header.php';
?>
	...
	<div class="well text-dark">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="officer-cropped"
					style="background-image: url('/images/Officers/IR_Tim_Vincent.jpg')">
				</div>
			</div>
			<div class="col-md-9">
				<h3>Tim Vincent</h3>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<p><em>Committee Involvement</em>: <a href="/committees/rov/">ROV</a>, <a href="/committees/rocket/">Rocket</a></p>
			</div>
		</div>
