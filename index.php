...
?>
    ...
    <!-- Info Sessions -->
    <div class="well card-1 text-dark">
		<h2 style = "text-align: center;"> Our General Callout is on Wed 1/27 from 6:30-8:00 PM over the <a href="https://discord.gg/kZNkKXM" target="_blank">IEEE Q&A Discord.</a> If you couldn't attend, you can watch a YouTube prerecording (coming soon). Please see our <a href="/calendar.php">calendar</a> for upcoming events, and <a href="/join.php">join IEEE!</a></h2>
